...
void main() => runApp(ImageView360UI());

class ImageView360UI extends StatelessWidget {
  @override
...
class _DemoPageState extends State<DemoPage> {
  ...
  void updateImageList(BuildContext context) async {
    for (int i = 1; i <= 43; i++) {
      imageList.add(AssetImage('assets/images/img ($i.png'));
      await precacheImage(AssetImage('assets/images/img ($i.png'), context);
    }
    setState(() {
      imagePrecached = true;
    });
